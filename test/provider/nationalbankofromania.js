...
describe('national bank of romania provider', function () {
    it('it_throws_an_exception_when_base_rate_is_not_RON_sync', function () {
        ...
        }, UnsupportedCurrencyPairException, 'The currency pair "USD/AED" is not supported or "National Bank of Romania" changed the response format')
    });
    ...
    it('it_throws_an_exception_when_rate_not_supported_sync', function () {
        ...
        assert.throw(function () {
            provider.fetchRateSync(currencyPair);
        }, UnsupportedCurrencyPairException, 'The currency pair "RON/PKR" is not supported or "National Bank of Romania" changed the response format')
    });
